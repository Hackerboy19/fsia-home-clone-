...
<footer class="fsia-ft">
  <div class="ftw">
    <div class="ft-grid">

      <!-- Brand -->
      <div class="ft-brand">
        <a href="/index.php" class="bm">
          <img src="/assets-new/media/logo.gif" alt="Forever Star India" class="bm-img">
        ...
        <div class="ft-socials">
          <a href="https://www.facebook.com/Foreverstarindiaawards/" target="_blank" rel="noopener" aria-label="Facebook"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg></a>
      ...
      <div class="ft-col">
        ...
        <div class="ft-list">
          ...
          <a href="/register-nominate.php">Nominate Yourself</a>
        </div>
      </div>

      <!-- Quick Links -->
      <div class="ft-col">
        <h4>Quick Links<span class="ft-cv">›</span></h4>
        <div class="ft-list">
          <a href="/about.php">About FSIA</a>
          ...
          <a href="/news.php">News Coverage</a>
          <a href="/online-franchise-application" target="_blank" rel="noopener">Apply for Franchise</a>
			<a href="/sitemap.php" target="_blank" rel="noopener">Sitemap</a>
        </div>
      </div>

      <!-- Contact -->
      <div class="ft-contact ft-col">
        <h4>Get In Touch<span class="ft-cv">›</span></h4>
        <a href="tel:+919983286999">
          <span class="ci"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 3.09 4.18 2 2 0 0 1 5.07 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L9.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>
          <span>+91-99832-86999<small>Mon–Sat, 10am–7pm</small></span>
        </a>
        <a href="mailto:care@fsia.in">
          <span class="ci"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 7l10 7 10-7"/></svg></span>
          <span>care@fsia.in<small>We reply within 24 hours</small></span>
        </a>
        <a href="https://wa.me/919983286999" target="_blank" rel="noopener">
          <span class="ci"><svg width="15" height="15" viewBox="0 0 32 32" fill="currentColor"><path d="M16 4C9.9 4 5 8.9 5 15c0 1.9.5 3.8 1.5 5.5L5 27l6.8-1.8A11 11 0 1 0 16 4zm0 20a9 9 0 0 1-4.6-1.3l-.3-.2-3.6.9.9-3.5-.2-.4A9 9 0 1 1 16 24z"/></svg></span>
...
(function(){
  document.addEventListener('submit', function(e){
    if (e.defaultPrevented) return; // validation failed, let user retry
    ...
    if (btn.dataset.locked === '1') {
      e.preventDefault(); // block double-submit (e.g. double click)
      return;
    }
  ...
  }); // NOTE: no capture phase — must run AFTER inline onsubmit validators
})();
</script>
<script>
(function () {
  ...
  ready(function () {
    var heads = document.querySelectorAll('.fsia-ft .ft-col h4');
    Array.prototype.forEach.call(heads, function (h) {
      h.addEventListener('click', function () {
        if (window.innerWidth <= 560) { h.parentElement.classList.toggle('open'); }
      });
    });
  });
})();
...
<!-- Google tag (gtag.js) -->
<script   src="https://www.googletagmanager.com/gtag/js?id=G-Y4WSHCXRGB"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-Y4WSHCXRGB');
</script>
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-T3674CM');</script>
<!-- End Google Tag Manager -->
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T3674CM"
